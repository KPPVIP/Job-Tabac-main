...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "tabac_stream", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "tabac_stream", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "tabac_stream", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.35 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "tabac_stream", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "tabac_stream", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 76 },
...
print("------------------------------------------------------")
print("Job Tabac Free réalisé par Galaxie Geek#1486")
pint("Ne pas revendre ou s'approprier le job ^^")
print("Universe Dev : https://discord.gg/qBPjHQfzm8")
print("------------------------------------------------------")